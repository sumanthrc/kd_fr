...
def main(args):
    ...
    def _build_adaface_res50():
        ...
        checkpoint = torch.load("teacher/adaface_ir50_ms1mv2.ckpt", map_location=torch.device(local_rank))
    ...
    if cfg.loss == "ArcFace":
        ...
        header = losses.AdaptiveAdaFace(in_features=cfg.embedding_size, out_features=cfg.num_classes, s=cfg.s, m=cfg.m, h=cfg.h, t_alpha=cfg.t_alpha, adaptive_weighted_alpha=cfg.adaptive_alpha).to(local_rank)
    else:
