...
from evaluation_code.transform import normalize_and_scale_image
...
class Embedding(object):
    def __init__(self, rank, model, data_shape, image_size, batch_size=1):
        ...
        src = np.array([
            ...
            [48.0252, 71.7366],
            [33.5493, 92.3655],
            [62.7299, 92.2041]], dtype=np.float32) * (image_size // 112)
        src[:, 0] += 8.0
        self.src = src
    ...
    def forward_db(self, batch_data):
        ...
        imgs = normalize_and_scale_image(imgs)
...
def ijb_eval(rank, model, **kwargs):
    model_path = kwargs["model_path"]
    target = kwargs["eval_target"] # #IJBB or IJBC
